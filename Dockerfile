...
# Cache bust ARG - change this value to force rebuild of URL replacement
ARG CACHEBUST=1
RUN echo "Cache bust: $CACHEBUST" && scripts/replace-placeholder.sh http://NEXT_PUBLIC_WEBAPP_URL_PLACEHOLDER ${NEXT_PUBLIC_WEBAPP_URL}
